...
const HorizontalBarChart = () => {
  ...
  const originalData = [
     { name: 'Initial construction cost', value: 67.013, color: '#E09365' },
     { name: 'Embodied carbon emissions', value: 11.020, color: '#638B48' },
       { name: 'Time cost estimate', value: 16.75, color: '#6F6F6F' },
    { name: 'Road user cost', value: 82.617, color: '#638B48' },
    ...
    {name:'TotalLifeCycleCost',value: 212.15, color: '#638B48' }
  ];
