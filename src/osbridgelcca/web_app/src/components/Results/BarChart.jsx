...
//   const originalData = [
//      { name: 'Initial construction cost', value: 61.83, color:  '#638B48' },
//      { name: 'Embodied carbon emissions', value: 8.53, color:  '#6F6F6F'},
//        { name: 'Time cost estimate', value: 2.32, color:'#638B48'  },
//     { name: 'Road user cost', value: 123.93, color:'#E09365' },
...
//     {name:'TotalLifeCycleCost',value: 259.15, color: '#FFFFFF' }
//   ];
...
//     <ReusableBarChart
//       data={data}
//       title="Life-Cycle Costs for 50 years"
