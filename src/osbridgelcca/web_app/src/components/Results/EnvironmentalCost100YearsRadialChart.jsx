...
const EnvironmentalCost100YearsRadialChart = () => {
  ...
  const percentages = [5, 12.85, 18.5, 9]; // Initial, Use, End of Life, Beyond Life
  ...
  return (
    <RadialChart
      data={data}
      title="Environmental cost distribution across various stages for PSC bridges for 100 years"
      titleColor="#2E5743"
